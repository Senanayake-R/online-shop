...
public class CartServlet extends HttpServlet {
        ...
        try {
            ...
            if (amountToPay > 0) {
                pw.println("    <tr style='background-color:green'>\r\n"
                        ...
                        + "      <td colspan='1' style='color:white; font-weight:bold'><span>LKR</span> "
                        + amountToPay
                        + "</td>\r\n"
                        + "    </tr>\r\n");
            }
            ...
            if (amountToPay > 0) {
                pw.println("<div style='text-align:right; margin-right:20px;'>\r\n"
                        ...
                        + "<input type='submit' class=\"btn btn-primary\" name='pay' value='Proceed to Pay LKR "
                        + amountToPay + "'/></form>"
                        + "    </div>");
            }
        } catch (Exception e) {
    ...
    public String getRowData(Cart cart) {
        ...
        return "    <tr>\r\n"
                ...
                + "      <td><span>LKR</span> " + book.getPrice() + "</td>\r\n"
                ...
                + "      <td><span>LKR</span> " + (book.getPrice() * cart.getQuantity()) + "</td>\r\n"
                + "    </tr>\r\n";
    }
