    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            if ("SUCCESS".equalsIgnoreCase(message)) {
                ...
                rd.include(req, res);
                pw.println(
                        "<table class=\"tab\"><tr><td>Item Details Updated Successfully!<br/>Add More Items</td></tr></table>");
            } else {
                RequestDispatcher rd = req.getRequestDispatcher("AddBook.html");
                pw.println("<table class=\"tab\"><tr><td>Failed to Add Items! Fill up CareFully</td></tr></table>");
                rd.include(req, res);
            }
        } catch (Exception e) {
            e.printStackTrace();
